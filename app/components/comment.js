    ...
    */
    handleLikeClick(clickEvent) {
      ...
      if (this.didUserLike()) {
        ...
        unlikeComment(this.props.feedItemKey,4, this.props.commentIndex,callbackFunction);
      } else {
        // User clicked 'like' button.
        likeComment(this.props.feedItemKey, 4, this.props.commentIndex,callbackFunction);
      }
    }
  }
