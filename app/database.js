...
var initialData = {
  //The "user" collection. Contains all of the usres in our Facebook systems.
  "users": {
    // This user has id "1".
    "1": {
      "_id": 1,
  ...
  "feedItems": {
    "1": {
      ...
      //The type and contents of this feed item. This itiem happens to be a status
      //Update
      "type": "statusUpdate",
      "contents": {
  ...
  // "feeds" colletion. Feeds for each FB user.
  "feeds": {
    "4": {
      "_id": 4,
