...
/**
 ...
 // need to check the type and have logic for each type.
   ...
   * @param cb A Function object, which we will invoke when the Feed's data s available.
   */
  ...
  export function postStatusUpdate(user, location, contents, cb) {
    ...
    var newStatusUpdate = {
      ...
      // List of comments on the postDate
      "comments": []
    };
  ...
  */
  export function postComment(feedItemId, author, contents, cb) {
    ...
    // update the embedded object, and then update
  ...
  export function likeFeedItem(feedItemId, userId, cb) {
    ...
    // in this mock serve. ('push' modifies the array
  ...
  export function unlikeFeedItem(feedItemId, userId, cb) {
   ...
   // -1 means the user is *not* ub the likeCounter,
